...
- 和 [telegram-webapp-observability.md](/Volumes/Data/Github/threadBridge/docs/plan/telegram-adapter/telegram-webapp-observability.md) 直接相關
  - Web App 若要顯示 thread 即時狀態，需要先有明確的 busy 語義
- 和 [topic-title-status.md](/Volumes/Data/Github/threadBridge/docs/plan/telegram-adapter/topic-title-status.md) 相關
  - 若之後想把 topic title 當狀態欄，`running` 會是重要訊號
- 和 [message-queue-and-status-delivery.md](/Volumes/Data/Github/threadBridge/docs/plan/telegram-adapter/message-queue-and-status-delivery.md) 直接相關
