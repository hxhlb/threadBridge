...
- mirror intake observer 化細節  
  這由 [app-server-ws-mirror-observer.md](/Volumes/Data/Github/threadBridge/docs/plan/app-server-observer/app-server-ws-mirror-observer.md) 處理
- Telegram adapter 的完整抽象化路線  
  這由 [runtime-transport-abstraction.md](/Volumes/Data/Github/threadBridge/docs/plan/runtime-control/runtime-transport-abstraction.md) 與 [telegram-adapter-migration.md](/Volumes/Data/Github/threadBridge/docs/plan/telegram-adapter/telegram-adapter-migration.md) 處理
