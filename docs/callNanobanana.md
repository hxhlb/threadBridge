...
This file documents the request shape used by `runtime_support/tools/generate_image.py` without including any live credential, cookie, or captured production payload.
