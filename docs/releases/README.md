...
For the first RC path, `release_threadbridge.sh` publishes to a GitHub draft prerelease only. Homebrew tap publication is intentionally deferred.
...
- run `scripts/release_threadbridge.sh`
